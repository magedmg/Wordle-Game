function player2Feedback(winGame, wordCharacter, player2Guess, remainingGuesses)
    % Function to give feedback to Player 2 if they have yet to win the
    % game
    ...
    if winGame ~= true
        ...
        for characterCheck = 1:length(wordCharacter)
            ...
            if player2Guess(characterCheck) == letter
            ...
            % postion
            elseif any(player2Guess==letter)
