function playerFeedback(winGame, wordCharacter, guess, remainingGuesses)
    % Function to give feedback to the player if they have yet to win the
    % game
    ...
    if winGame ~= true
        ...
        for characterCheck = 1:length(wordCharacter)
            ...
            if guess(characterCheck) == letter
